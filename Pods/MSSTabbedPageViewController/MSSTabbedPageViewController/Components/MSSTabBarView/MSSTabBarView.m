...
// defaults
CGFloat     const MSSTabBarViewDefaultHeight = 70.0f;
CGFloat     const MSSTabBarViewDefaultTabIndicatorHeight = 3.0f;
...
NSInteger   const MSSTabBarViewMaxDistributedTabs = 0;
